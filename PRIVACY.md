...
For maximum privacy, use the local npm package:
    ...
    npx @ansvar/swedish-standards-mcp
...
- Contains **only** publicly available data from authoritative Swedish government sources

## Data Sources

All data in this MCP is sourced from publicly available Swedish government
publications and agency websites. See `sources.yml` for the full list of data
origins and their licenses.
